...
public OnPluginStart()
{
	...
	hEnabled = CreateConVar("l4d2_ais_enabled", "1", "1=开启插件", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	hDisableInVersus = CreateConVar("l4d2_ais_disable_in_versus", "1", "1=在对抗模式自动禁用本插件", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	hFasterResponse = CreateConVar("l4d2_ais_fast_response", "1", "1=启用特感更快的反应", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	hFasterSpawn = CreateConVar("l4d2_ais_fast_spawn", "1", "1=禁用/启用更快的感染者产生(启用当SI产卵率高)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	hSafeSpawn = CreateConVar("l4d2_ais_safe_spawn", "0", "1=启用特感刷在安全门", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	hSpawnWeights[SI_BOOMER] = CreateConVar("l4d2_ais_boomer_weight", "100", "肥猪产生比重", FCVAR_PLUGIN, true, 0.0);
	hSpawnWeights[SI_HUNTER] = CreateConVar("l4d2_ais_hunter_weight", "100", "猎人产生比重", FCVAR_PLUGIN, true, 0.0);
	hSpawnWeights[SI_SMOKER] = CreateConVar("l4d2_ais_smoker_weight", "100", "长舌怪产生比重", FCVAR_PLUGIN, true, 0.0);
	hSpawnWeights[SI_TANK] = CreateConVar("l4d2_ais_tank_weight", "-1", "-1=系统产生坦克", FCVAR_PLUGIN, true, -1.0);
	hSpawnWeights[SI_CHARGER] = CreateConVar("l4d2_ais_charger_weight", "100", "充电器产生比重", FCVAR_PLUGIN, true, 0.0);
	hSpawnWeights[SI_JOCKEY] = CreateConVar("l4d2_ais_jockey_weight", "100", "骑士产生比重", FCVAR_PLUGIN, true, 0.0);
	hSpawnWeights[SI_SPITTER] = CreateConVar("l4d2_ais_spitter_weight", "100", "毒液婆产生比重", FCVAR_PLUGIN, true, 0.0);
	hSpawnLimits[SI_BOOMER] = CreateConVar("l4d2_ais_boomer_limit", "2", "肥猪最大数量", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_HUNTER] = CreateConVar("l4d2_ais_hunter_limit", "2", "猎人最大数量", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_SMOKER] = CreateConVar("l4d2_ais_smoker_limit", "2", "长舌怪最大数量", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_TANK] = CreateConVar("l4d2_aiimits_tank_l", "1", "坦克最大数量", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_CHARGER] = CreateConVar("l4d2_ais_charger_limit", "2", "充电器最大数量", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_JOCKEY] = CreateConVar("l4d2_ais_jockey_limit", "2", "骑士最大数量", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_SPITTER] = CreateConVar("l4d2_ais_spitter_limit", "2", "毒液婆最大数量", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	...
	hWitchLimit = CreateConVar("l4d2_ais_witch_limit", "-1", "-1=不限制女巫的数量", FCVAR_PLUGIN, true, -1.0, true, 100.0);
	hWitchPeriod = CreateConVar("l4d2_ais_witch_period", "200.0", "女巫产生的时间", FCVAR_PLUGIN, true, 1.0);
	hWitchPeriodMode = CreateConVar("l4d2_ais_witch_period_mode", "1", "女巫产卵率一致性[0 =常数| 1 =变量]", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	hSILimit = CreateConVar("l4d2_ais_limit", "8", "特感同时产生多少只，最大", FCVAR_PLUGIN, true, 1.0, true, float(MAX_INFECTED));
	...
	hSpawnTimeMode = CreateConVar("l4d2_ais_time_mode", "0", "[0 =随机| 1 =增量| 2 =递减]特感产生模式", FCVAR_PLUGIN, true, 0.0, true, 2.0);
	...
	hSpawnTimeMin = CreateConVar("l4d2_ais_time_min", "30.0", "特感最小产卵时间", FCVAR_PLUGIN, true, 0.0);
	hSpawnTimeMax = CreateConVar("l4d2_ais_time_max", "40.0", "特感最大产卵时间", FCVAR_PLUGIN, true, 1.0);
